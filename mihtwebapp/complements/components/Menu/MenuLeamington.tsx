        ...
        <div className={styles.Menu}>
            <div className={styles.MenuSectionsContainer}>
                <div className={styles.Sections}>
                    <a className={styles.SectionLink} href="#Antojitos">Antojitos / Snacks</a>
                    <a className={styles.SectionLink} href="#DeLaCocinaMexicana">De la Cocina Mexicana / From the Cuisine</a>
                    <a className={styles.SectionLink} href="#DeLaParrilla">De la Parrilla / From the Grill</a>
                    <a className={styles.SectionLink} href="#DeLaCazuela">De la Cazuela / From the Pot</a>
                    <a className={styles.SectionLink} href="#DelMar">Del Mar / From the Sea</a>
                    ...
                    <a className={styles.SectionLink} href="#Postres">Postres / Deserts</a>
                    <a className={styles.SectionLink} href="#Bebidas">Bebidas / Beverages</a>
                </div>
            </div>
            <div className={styles.MenuElements}>
                <p className={styles.SectionMenuTitle} id="Antojitos"><strong>Antojitos / Snacks</strong></p>
                ...
                <div className={styles.SectionMenu}>
                    ...
                    />
                    <MenuItem 
                        Title1="Tostadas de Camarón"
                        Title2="Shrimp Tostada"
                        // Price={23}
