        ...
        <div className={styles.Menu}>
            <div className={styles.MenuSectionsContainer}>
                <div className={styles.Sections}>
                    <a className={styles.SectionLink} href="#">Entradas</a>
                    <a className={styles.SectionLink} href="#">Antojitos</a>
                    <a className={styles.SectionLink} href="#">De la Cocina Mexicana</a>
                    <a className={styles.SectionLink} href="#">De la Parrilla</a>
                    <a className={styles.SectionLink} href="#">De la Olla</a>
                    <a className={styles.SectionLink} href="#">Del Mar</a>
                    <a className={styles.SectionLink} href="#">Tacos & Quesadillas</a>
                    <a className={styles.SectionLink} href="#">Extras</a>
                    <a className={styles.SectionLink} href="#">Postres</a>
                    <a className={styles.SectionLink} href="#">Bebidas</a>
