...
export default function NavMenu(){
    return (
        <nav className={styles.NavBarContainer}>
            ...
            <a target="_blank" className={styles.MenuButtom} href="https://order.tbdine.com/pickup/28824/menu" >Pedido en Linea</a>
            <a target="_blank" className={styles.MenuButtom} href="tel:+1-519-329-1615" >Pedido Telefónico</a>
