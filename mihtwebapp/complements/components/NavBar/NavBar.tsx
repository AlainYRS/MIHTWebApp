...
export default function NavMenu(){
    return (
        <nav className={styles.NavBarContainer}>
            ...
            <a target="_blank" rel="noopener noreferrer" className={styles.MenuButtom} href="https://order.tbdine.com/pickup/28824/menu" >Hacer pedido<br/><p className={styles.EngTitle}>Online Order</p></a>
            <a target="_blank" rel="noopener noreferrer" className={styles.MenuButtom} href="tel:+1-519-329-1615" >Pedido Telefónico<br/><p className={styles.EngTitle}>Phone Order</p></a>
