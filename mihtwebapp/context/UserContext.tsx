...
// import { useRouter } from 'next/navigation' //Library to manage the routes
...
import GlobalContext from './GlobalContextComp' //Global context component
...
import React, { useState, useEffect, ReactNode } from 'react' //React library
...
// const UserContext = (props: any) => {
    ...
    // const { push } = useRouter() //Deconstructing the useRouter hook to get the locale and locales parameters and the push function to change the locale parameter.
    ...
    return (
        ...
        >
            <IntlProvider locale={Locale} messages={LangLegends}> {/*This IntlProvider is used to implement the translations based on the user preferences.*/}
                ...
                {children} {/*This props.children is used to render the children components.*/}
            </IntlProvider>
