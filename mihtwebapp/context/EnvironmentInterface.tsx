...
interface iModelAi{
    model:  'gpt-4o' // GPT-4o: Our high-intelligence flagship model for complex, multi-step tasks. GPT-4o is cheaper and faster than GPT-4 Turbo. [1].	128,000 tokens	4,096 tokens	Up to Oct 2023
